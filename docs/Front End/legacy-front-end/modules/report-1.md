...
> Networking uses your existing `modules.api` wrapper. Success path shows _“Successfully Submitted Report!”_; failure toasts _“Error Saving: …”_. 
...
- **Empty reason only check**: It only checks _existence_ and _length_; you might want to trim whitespace and enforce a minimum length (e.g., ≥ 10 chars). 
