...
next:
  description: ''
---
Sometimes it can be useful to use an image as a data source by using a OCR library to read content in an image.  This is used to convert a human design profile to data of their gates that can be store in DB and indexable.  This could also be used for things like reading event flyers and extracting data.  Or other possibilities.
